...
If a name already exists in that scope, nothing is written until you say so. The CLI reports the conflicts and asks you to rerun with `--force`. The scope ends up wholly as the bundle or wholly as it was.
