...
You need [herdr](https://herdr.dev) 0.8.2 or later and [Go](https://go.dev) 1.27 or later. Linux and macOS. On Windows, install both herdr and this plugin inside WSL2.
