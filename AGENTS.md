...
herdr ≥ 0.7.5 plugin. Sequences short linear YAML workflows (`agent` / `run` / `herdr` / `workflow`). herdr owns panes/UI; this repo only loads and runs steps. Runtime is Bun + TypeScript ESM.
