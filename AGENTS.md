...
| `src/history/`                               | atomic run snapshots, list/detail projection, retention                                                                                                                                                                                                                                                  |
...
| `src/run/`                                   | runner.ts, recorder.ts, context.ts (step contracts, outcomes, coordination errors, herdr step), steps/ (agent, shell, pane placement, include)                                                                                                                                                           |
| `src/tui/`                                   | picker.ts, picker-rows.ts, picker-actions.ts (ctrl+k palette), picker-chrome.ts, runs-browser.ts, run-history.ts, run-launch.ts, theme.ts, update-indicator.ts                                                                                                                                           |
