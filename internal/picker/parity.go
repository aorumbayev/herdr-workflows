...
func ParityBaseline() []ParitySurface {
	...
	return []ParitySurface{
		...
		{Spec: presentation, Requirement: "Picker chrome uses width-stable ASCII glyphs", Scenario: "ASCII greater-than cursor on choice option rows", Kind: "view", GoSurface: "FormatPickerRowName/renderChoice", CoveringTest: "TestParityChoiceRowsUseASCIICursorAndLocation"},
		...
		{Spec: actions, Requirement: "Palette actions for authorship and discovery", Scenario: "New from empty catalog", Kind: "action", GoSurface: "handlePalette n/EditWorkflow", CoveringTest: "TestParityPaletteLettersHandoff"},
		...
		{Spec: actions, Requirement: "Palette open edits the selected workflow", Scenario: "Open repo workflow", Kind: "action", GoSurface: "handlePalette o/EditWorkflow", CoveringTest: "TestParityPaletteLettersHandoff"},
