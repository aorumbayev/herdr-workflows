...
func ParityBaseline() []ParitySurface {
	...
	return []ParitySurface{
		...
		{Spec: presentation, Requirement: "Picker hosts a browse console tab with pop-out", Scenario: "Browse in the popup", Kind: "view", GoSurface: "Model.OpenDiagram/picker.openConsoleTab", CoveringTest: "picker.TestConsoleTabOpensSelectedDiagram"},
		{Spec: presentation, Requirement: "Picker hosts a browse console tab with pop-out", Scenario: "Leave the diagram for the workflows tab", Kind: "transition", GoSurface: "picker.handleConsoleKey", CoveringTest: "picker.TestConsoleTabOpensSelectedDiagram"},
		{Spec: presentation, Requirement: "Picker hosts a browse console tab with pop-out", Scenario: "Embedded console fits below the tab bar", Kind: "view", GoSurface: "picker.tabBodyHeight", CoveringTest: "picker.TestPickerFrameFitsPopupHeight"},
		{Spec: presentation, Requirement: "Picker hosts a browse console tab with pop-out", Scenario: "Pop-out uses placement", Kind: "transition", GoSurface: "Model.BlocksPopOut/picker.beginConsolePlacement", CoveringTest: "picker.TestConsoleTabPOpensPlacement"},
		...
		{Spec: presentation, Requirement: "Console mouse reporting is on in both hosts", Scenario: "Picker console tab forwards wheel", Kind: "transition", GoSurface: "picker.handleMouseWheel/forwardConsole", CoveringTest: "picker.TestConsoleTabForwardsDiagramWheel"},
	}
}
