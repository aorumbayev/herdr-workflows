...
func ParityBaseline() []ParitySurface {
	...
	return []ParitySurface{
		...
		{Spec: presentation, Requirement: "Diagram send-back types an annotation bundle into an agent pane", Scenario: "Chooser rows read as tab, status, and title", Kind: "view", GoSurface: "FormatAgentPickBody/host.ParseAgentPanes", CoveringTest: "TestAgentPickBodyShowsTabStatusTitleAndSelfMarker"},
		{Spec: presentation, Requirement: "Diagram send-back types an annotation bundle into an agent pane", Scenario: "Chooser marks the caller's own pane", Kind: "view", GoSurface: "AgentPaneEntry.Self/FormatAgentPickBody", CoveringTest: "TestAgentPickBodyTruncatesOnlyTheTitle"},
