...
func ParityBaseline() []ParitySurface {
	...
	return []ParitySurface{
		...
		{Spec: presentation, Requirement: "Run detail offers retry", Scenario: "Retry launch shows saved workflow consent", Kind: "view", GoSurface: "picker.beginRunsRetry", CoveringTest: "picker.TestRunsRetryKeysLaunchTheRecordedRun"},
		{Spec: presentation, Requirement: "Run detail offers retry", Scenario: "Retry can launch when workflow is missing from this checkout", Kind: "action", GoSurface: "picker.beginRunsRetry", CoveringTest: "picker.TestRunsRetryCanLaunchWhenWorkflowMissingFromThisCheckout"},
