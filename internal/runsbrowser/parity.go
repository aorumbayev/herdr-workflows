...
func ParityBaseline() []ParitySurface {
	...
	return []ParitySurface{
		...
		{Spec: presentation, Requirement: "Every selected run has a compact detail view", Scenario: "Workbench handoff fails", Kind: "action", GoSurface: "handleDetailKey w", CoveringTest: "TestParityWorkbenchHandoffNilKeepsDetail", Gap: "nil launchWorkbench no-ops without width-bounded handoff error"},
